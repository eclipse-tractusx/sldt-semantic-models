...
At the top level, the BillOfProcess entity provides a version that represents the version of the data model, a unique identifier for the bill of process, and a name for the product 
